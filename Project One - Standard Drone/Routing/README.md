...
|---|---|---|---|
| [WI-01](WI-01-bench-setup-and-frame.md) | Bench setup, frame assembly, motor mounting | No FC | **complete Sep 20** — photos taken for the WIs |
| [WI-02](WI-02-esc-soldering.md) | ESC soldering — motors, XT60, capacitor | No FC | next — after soldering-technique videos |
